...
export default function SubscriberIncreaseLow() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await Getmethod(`${process.env.REACT_APP_BACKEND_API}/ranking/SubscriberLowIncrease`)
  ...
  <div className="flex flex-col md:flex-row justify-between items-center gap-2">
    <div className="grid gap-6 w-full">
      <div className="five sm:block md:flex justify-between items-center">
        <span className=" text-xs whitespace-nowrap">금일 구독자 하락 상위</span>
