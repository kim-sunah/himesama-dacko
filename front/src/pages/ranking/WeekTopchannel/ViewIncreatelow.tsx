...
export default function WeekViewIncreaseLow() {
    const navigate = useNavigate();
    const [Top, SetTop] = useState<channeInfo[]>([]);
    useEffect(() => {
        const fetchData = async () => {
            const response = await Getmethod(`${process.env.REACT_APP_BACKEND_API}/ranking/WeekViewLowIncrease`)
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-2">
          <div className="grid gap-6 w-full">
            <div className="five flex justify-between items-center">
              <h1 className="mb-4">이번주 조회수 하락 상위</h1>
