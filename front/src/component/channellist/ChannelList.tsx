...
export default function ChannelList() {
    useEffect(() =>{
        fetch(`${process.env.REACT_APP_BACKEND_API}/subscriber/top-channels`,{method : "GET", headers:{"Content-Type" : "application/json"}}).then(res=>res.json()).then(resData=>console.log(resData)).catch(err=>console.log(err))
