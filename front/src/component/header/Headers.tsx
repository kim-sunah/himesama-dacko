    ...
    const getYouTubeChannelId = async (event: FormEvent<HTMLFormElement>): Promise<any> => {
        ...
        if (ChannelId.current!.value.includes('http')) {
            if (ChannelId.current!.value.includes('@')) {
                ...
                const respose = await fetch("https://port-0-himesama-dacko-16yzlb2alrh4xa0h.sel5.cloudtype.app/ranking/channellist/channelurl", {
                    method: "POST",
                ...
                if (channel) {
                    ...
                    const respose = await fetch("https://port-0-himesama-dacko-16yzlb2alrh4xa0h.sel5.cloudtype.app/ranking/channellist/channelId", {
                        method: "POST",
                        headers: { "Content-Type": "application/json" },
            ...
            // const respose = await Getmethod(`https://port-0-himesama-dacko-16yzlb2alrh4xa0h.sel5.cloudtype.app/ranking/channellist/channel/${ChannelId.current!.value}`);
